...
kubernetes_version      = "1.35.4"             # Kubernetes version for AKS cluster

# GitOps Configuration
gitops_repo_url  = "https://github.com/Vaidic-afk/GitOps-Project.git" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/Vaidic-afk/GitOps-Project.git" # Repository containing your application manifests
app_repo_path = "./3-tire-configs"                                   # Path within app repository containing Kubernetes manifests
